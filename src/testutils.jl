...
julia> JosephsonCircuits.testshow(stdout,JosephsonCircuits.LinearHB(Complex{Float64}[;;;], Complex{Float64}[;;;], Complex{Float64}[;;;], Complex{Float64}[;;;], Complex{Float64}[;;], Complex{Float64}[;;], Complex{Float64}[;;], Complex{Float64}[;;], 1, 1, 1, 1, 1.0,(0,)))
JosephsonCircuits.LinearHB(Array{ComplexF64, 3}(undef, 0, 0, 0), Array{ComplexF64, 3}(undef, 0, 0, 0), Array{ComplexF64, 3}(undef, 0, 0, 0), Array{ComplexF64, 3}(undef, 0, 0, 0), Matrix{ComplexF64}(undef, 0, 0), Matrix{ComplexF64}(undef, 0, 0), Matrix{ComplexF64}(undef, 0, 0), Matrix{ComplexF64}(undef, 0, 0), 1, 1, 1, 1, 1.0, (0,))

julia> JosephsonCircuits.testshow(stdout,JosephsonCircuits.HB(JosephsonCircuits.NonlinearHB((1.0e9,),JosephsonCircuits.Frequencies{1}((0,), (1,), (0,), CartesianIndex{1}[CartesianIndex(1,)], [(0,)]),Complex{Float64}[],JosephsonCircuits.SparseArrays.sparse([1, 2, 3, 4], [1, 2, 3, 4], [1, 1, 1, 1], 4, 4), JosephsonCircuits.SparseArrays.sparsevec([2], [1.0e-9], 2), JosephsonCircuits.SparseArrays.sparsevec(Int64[], Nothing[], 2), JosephsonCircuits.SparseArrays.sparsevec([3, 4], [1.0e-9, 1.0e-9], 4), 2, 2, ComplexF64[0.0 + 0.0im 0.0 + 0.0im; 0.0 + 0.0im 0.0 + 0.0im]),JosephsonCircuits.LinearHB(Complex{Float64}[;;;], Complex{Float64}[;;;], Complex{Float64}[;;;], Complex{Float64}[;;;], Complex{Float64}[;;], Complex{Float64}[;;], Complex{Float64}[;;], Complex{Float64}[;;], 1, 1, 1, 1, 1.0,(0,))))
JosephsonCircuits.HB(JosephsonCircuits.NonlinearHB((1.0e9,), JosephsonCircuits.Frequencies{1}((0,), (1,), (0,), CartesianIndex{1}[CartesianIndex(1,)], [(0,)]), ComplexF64[], sparse([1, 2, 3, 4], [1, 2, 3, 4], [1, 1, 1, 1], 4, 4), sparsevec([2], [1.0e-9], 2), sparsevec(Int64[], Nothing[], 2), sparsevec([3, 4], [1.0e-9, 1.0e-9], 4), 2, 2, ComplexF64[0.0 + 0.0im 0.0 + 0.0im; 0.0 + 0.0im 0.0 + 0.0im]), JosephsonCircuits.LinearHB(Array{ComplexF64, 3}(undef, 0, 0, 0), Array{ComplexF64, 3}(undef, 0, 0, 0), Array{ComplexF64, 3}(undef, 0, 0, 0), Array{ComplexF64, 3}(undef, 0, 0, 0), Matrix{ComplexF64}(undef, 0, 0), Matrix{ComplexF64}(undef, 0, 0), Matrix{ComplexF64}(undef, 0, 0), Matrix{ComplexF64}(undef, 0, 0), 1, 1, 1, 1, 1.0, (0,)))
```
"""
