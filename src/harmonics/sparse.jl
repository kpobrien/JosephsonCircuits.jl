...
by the vector method of [`sparseaddconjsubst!`](@ref) (which applies it
during assembly; the `Diagonal` method still conjugates through its
`conjflag`), and by `sensitivitystampvalue` (which applies it to the
sensitivity stamps).
"""
