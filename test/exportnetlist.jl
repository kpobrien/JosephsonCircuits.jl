...
@testset verbose=true "exportnetlist" begin
    ...
    @testset "calcCjIcmean errors" begin
        begin
            ...
            componentvalues = Real[1, 50.0, 1.0e-13, 1.0e-9, 1.0e-12, 1.0e-13, 100*1.1e-9, 1.2e-12]
            ...
            @test_throws(
                ...
                JosephsonCircuits.calcCjIcmean(componenttypes, nodeindexarray,
                    componentvalues, componentnamedict,mutualinductorbranchnames, countdict, indexdict)
            )
        end

        begin
            componenttypes = [:P, :R, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :Lj, :C, :C, :R, :P]
            ...
            @test_throws(
                ...
                JosephsonCircuits.calcCjIcmean(componenttypes, nodeindexarray,
                    vvn, componentnamedict,mutualinductorbranchnames, countdict, indexdict)
            )
        end
