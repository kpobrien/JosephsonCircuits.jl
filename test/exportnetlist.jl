...
@testset verbose=true "exportnetlist" begin
    ...
    @testset "componentdictionaries" begin
        ...
        @test_throws(
            ...
            JosephsonCircuits.componentdictionaries(typevector,
                nodeindices,componentnamedict,mutualinductorvector)
        )
    end
    ...
    @testset "calcCjIcmean" begin
        ...
        @test_throws(
            ...
            JosephsonCircuits.calcCjIcmean(typevector, nodeindexarray,
                vvn, componentnamedict,mutualinductorvector, countdict, indexdict)
        )
    end
    ...
    @testset "calcCjIcmean" begin
        ...
        @test_throws(
            ...
            JosephsonCircuits.calcCjIcmean(psc.typevector, psc.nodeindices,
                vvn, psc.componentnamedict,psc.mutualinductorvector, countdict, indexdict)
            )
